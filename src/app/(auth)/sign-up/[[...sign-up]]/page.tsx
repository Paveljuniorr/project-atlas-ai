  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#060815] text-white p-4">
      <div className="mb-6 text-center max-w-md">
        <h1 className="text-3xl font-bold text-white mb-2">Join Project Atlas AI</h1>
        <p className="text-white/80 text-sm">Create your account to automate your business</p>
      </div>
